...
<!--        <small class="pull-right" style="text-align:right;font-size:14px;color:#8e8e8e;width:500px;"><b>Find and view details of registered claims</b></small>-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box-header">
                <h3 class="box-title" style="color: #226e71;"> <s:property value="getText('collections.label')"/> </h3> - &nbsp;<i><h3 class="box-title" style="color: #226e71;" id="getRangeLabel"></h3></i>
                <div class="dropdown pull-right" style="margin-right:10px;">
                        <i class="fa  fa-bars fa-lg dropdown-toggle"  type="button" data-toggle="dropdown"></i>
                        <ul id="range_collections" style="margin-left:-150px;background-color: #656a6b;" class="dropdown-menu ">
            ...
            <div class="box-body no-padding table-responsive pre-scrollable" style="max-height:500px;">
              <table class="table table-striped" id="payment_table">
                ...
                <tr style="background-color:#ADC2EE;">
                    ...
                    <th class="text-right"> <s:property value="getText('collections.payment.id')"/> </th>
                    <th class="text-center"> <s:property value="getText('collections.payment.date')"/> </th>
                    <th class="text-right"> <s:property value="getText('inv.no')"/> </th>
                    <th class="text-center"> <s:property value="getText('customer.name')"/> </th>
                    <th class="text-center"> <s:property value="getText('collections.payment')"/> </th>
                    <th class="text-right"> <s:property value="getText('collections.payment.amount')"/> (<s:property value="getText('global.currency')" />)</th>
                    
                </tr>
                <s:set var="totalpayment" value="0"/>
                <s:iterator  value="collections" status="itStatus">  
                <s:set var="totalpayment" value="%{#totalpayment + paymentAmount}" />
				<fieldset>  
				<tr>
				<td><s:property value="#itStatus.count" />.</td>
				<td class="text-right"><s:property value="id.paymentId"/>   </td>
				<td class="text-center"><s:date name="id.paymentDate" format="%{getText('format.date')}"/>  </td>
			<%-- 	<td style="text-align:right;" id="inv_id"><a href="#"><s:property value="invNum"/></a></td> --%>
				<td class="text-right"><a href="InvoiceDetail?invoiceID=<s:property value="invNum"/>"><s:property value="invNum"/></a>   </td>
				<td class="text-center"><s:property value="customerName"/>  </td>
				<td class="text-center"><s:property value="paymentMode"/>  </td>
				<td class="text-right" style="width:15%;"> <s:property value="%{getText('format.currency.args',{paymentAmount})}"/></td>
				</tr> 
				</fieldset>  
				</s:iterator> 
            ...
            <table class="table table-condensed">
              <tbody>
              	<tr><td class="pull-right"><s:property value="getText('collections.total.payment.amount')"/>: <s:property value="getText('global.currency')"/> <b><s:property value="%{getText('format.currency.args',{#totalpayment})}"/>&nbsp&nbsp&nbsp&nbsp&nbsp</b></td></tr>
              </tbody>
            </table>
            </div>
            </div>
    ...
    <form action="collections_dashboard" name="hidden_data_for_range" method="post">
	...
	$(function(){
		$("#payment_table #inv_id a").click(function(evt){

...
<div class="wrapper">
  ...
  <div style="min-height: 595px;" class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Your Page Content Here -->
        <label style="font-size:25px;color: #226e71;"><s:property value="getText('invoice.search')"/></label>
 ...
 <table class="table"  style="width:650px; margin-left:15px; margin-bottom:0px; border-width: 0px;"><tr><td style="width:80%;border-top: 1px solid #ffffff;"> <div style="height:100px;" class="tab-content">
            ...
            <!-- /.tab-content -->
	         ...
	         <s:set var="results" value="%{orders.length}"/>
 			...
 			<%-- <label style="color:green;"><span id="noOfInv"><s:property value="results"/></span> <s:property value="getText('message_7')"/></label> --%>
 			</s:elseif>
 			<s:elseif test="%{#results==0}" > 
 				<!-- zero records found -->
 			 ...
 			 <s:elseif test="!hasActionErrors()">
 				 <label style="color:red;"><span id="noOfOrd"><s:property value="results"/></span> <s:property value="getText('message_7')"/></label>
 			 </s:elseif>
 			 
 			<s:set var="results1" value="%{customerName.length}"/>
 			<s:set var="results2" value="%{rejectClaim_List.length}"/>
	       
 			 <s:if test="%{#results2==0}">
 			 <label style="color:red;"><span id="noOfOrd"><s:property value="results2"/></span> <s:property value="getText('message_7')"/></label>
 			 </s:if>
 			 <s:elseif test="%{#results1>0}">
 			 <!-- More than 0 records found -->
 			<label style="color:green;"><span id="noOfOrd"><s:property value="results1"/></span> <s:property value="getText('message_7')"/></label>
 			</s:elseif>
        ...
        <div class="box box-primary">
            ...
            <div class="box-header">
              <h3 class="box-title" style="color: #226e71;"><s:property value="getText('all.invoices')"/></h3> &nbsp;<i><h3 class="box-title" style="color: #226e71;" id="Current_Date_Range"></h3></i>
                <div class="box-tools">
...
.table-striped>tbody>tr:nth-of-type(2n+1) {
	background-color: #F2F2F2;
								...
								<tr style="background-color: #ADC2EE;">
									...
									<th id="invoiceDate" style="text-align:center;"><s:property value="getText('invoice.date')"/></th>

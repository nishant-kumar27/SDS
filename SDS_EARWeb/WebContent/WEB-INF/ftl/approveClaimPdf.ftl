...
<table width="100%">
		<tr>
			...
			<th><small style="color:#4d4d4d">Invoice No</small></th><th>:</th><th><small>
				<#if invoicenNo??>
					${invoicenNo}
				<#else>
				</#if>
		...
		<tr>
			...
			<th><small style="color:#4d4d4d">Customer Name</small></th><th>:</th><th><small>
					<#if customerName??>
						${customerName}
					<#else>
					</#if>	
...
<table width="100%"  id="itemTable">
		<tr style="background-color:#ADC2EE;">
			...
			<th><h6>Approved<br>Price(<@s.property value="getText('global.currency')"/>) </h6></th>
		...
		<tr>
			...
			<td> 
				<#if lineItem.lineQntRtn??>
  					<#assign lnQty='${lineItem.lineQntRtn}'>
  					<h6>${lnQty}</h6>
				<#elseif lineItem.lineQnt??>
  					<#assign lnQty='${lineItem.lineQnt}'>
  					<h6>${lnQty}</h6>
  				<#else>
  					<#assign x = 0>
  					<h6>${x}</h6>		
				...
				<#assign totQyNo=totQy?number>
				<#assign lnQtyNo=lnQty?number>
				<#assign totQy=totQyNo + lnQtyNo>
			<td>

		...
		<tr>
			...
			<td>
				<#-- <#if lineItem.lineQntRtn??>
  					<#assign qtyToRtn=lineItem.lineQntRtn>
  				<#elseif lineItem.lineQnt??>
					<#assign qtyToRtn=lineItem.lineQnt>
  				<#else>
  					<#assign qtyToRtn = 0>
  				</#if>
				<h6>${lineItem.extnDscLnItm / qtyToRtn}</h6> -->
				<#assign des=lineItem.extnLnItmRtn - lineItem.extnDscLnItm>
				<#assign itpr=lineItem.itmPrnPrc>
				<h6>${itpr-des}</h6>
			</td>
			<td>
				<#if lineItem.lineQntRtn??>
			...
			<td> 
				<h6>${lineItem.extnLnItmRtn - lineItem.extnDscLnItm}</h6>
			</td>
			<td>

		...
		<td style="text-align:right;"> <h6 style="color:#4d4d4d">
			<@s.i18n
				...
				<@s.text name="salesInvoice.Address1" />
					 ...
					 <center><h1 style="color: #226e71;">Cancelled Order Details</h1></center>
<br>
...
<table width="100%">
		...
		<tr>
			...
			<th>
				...
				<th><small>
					<#if cancelOrder.orderDate??>
						<#setting date_format="dd-MMM-yyyy">
					<#setting locale="en_US">
					<#assign createdOn=cancelOrder.orderDate> 
		...
		<tr>
			<th>
				...
				<th><small>
				<#if cancelOrder.ordEfDate??>
							<#setting date_format="dd-MMM-yyyy">
					<#setting locale="en_US">
					<#assign createdOn=cancelOrder.ordEfDate> 
							${createdOn?datetime?string('dd-MMM-yyyy')}
				<#else>
				</#if>
		...
		<tr>
			...
			<th>
				...
				<th><small>
				<#if cancelOrder.deliveryComment??>
						${cancelOrder.deliveryComment}
					<#else>
					</#if> 
				</small>
			</th>

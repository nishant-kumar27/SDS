...
function doPrint() {
    var win = window.open('PrintOrderDetails?orderID=<s:property value="orderTran.getOrdTranSum().getIdOrd()"/>')
   	window.location = "order_Search";  
}
</script>
					...
					<div class="col-md-8">
						<div class="box">
							<div class="row" style="text-align: center">
								<h2><s:property value="orderHeadStatus"/></h2>
								<s:actionmessage/>
							</div>
							<div class="row ">
								<div class="col-md-6 ">
									<table style="width: 100%;" class="table">
										<tr>
											...
											<td><b><s:property value="orderTran.getOrdTranSum().getIdOrd()"/></b></td>
										</tr>
										<tr>
											<td style="text-align: right;"><s:property value="getText('order.date')"/>:</b></td>
											<td><b><s:date name="orderTran.businessDate()" format="%{getText('format.date')}" /></b></td>
										</tr>
										<tr>
											<td style="text-align: right;"><s:property value="getText('delivery.date')"/>:</b></td>
											<td><b><s:date name="orderTran.getOrdTranSum().getOrdDlvrDate()" format="%{getText('format.date')}" />
											</b></td>
										</tr>
											<tr>
											<td style="text-align: right;"><s:property value="getText('delivery.address')"/></b></td>
											<td style="word-break: break-word;"><b><s:property value="orderTran.getCtDvrInf()"/></b></td>
										</tr>
									</table>
								</div>
								<div class="col-md-6 ">
									...
									<tr>
											...
											<td><b><s:property value="orderTran.getCustomer().getCustomerHeader().getCustomerHeaderPK().getCustId()"/></b></td>
										</tr>
										<tr>
											<td style="text-align: right;"><s:property value="getText('customer.name')"/>:</b></td>
											<td><b><s:property value="orderTran.getCustomer().getCustomerHeader().getCtNm()"/></b></td>
										</tr>
										<tr>
											<td style="text-align: right;"><s:property value="getText('net.total')"/>:</b></td>
											<td><s:property value="getText('global.currency')"/>&nbsp;&nbsp;<b><s:property	value="%{getText('format.currency.args',{orderTran.getOrdTranSum().getDkartNetTot()})}"/></b></td>
										</tr>
									</table>
								</div>
							</div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-footer" style="margin:auto;max-width:300px;">
						...
						<%-- <form action="orders_details_page"><s:hidden name="orderId" value="orderTran.getOrdTranSum().getIdOrd()"></s:hidden> --%>
						<button type="button" onclick = "doPrint()" class="pull-left btn btn-primary center-block"
							id="printorder">

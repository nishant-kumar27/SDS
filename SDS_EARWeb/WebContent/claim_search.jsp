...
<div class="wrapper">
  ...
  <div style="min-height: 595px;" class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Your Page Content Here -->
        <label style="font-size:25px;color: #226e71;"><s:property value="getText('claim.search')"/></label>
            <small class="pull-right" style="text-align:right;font-size:14px;color:#8e8e8e;width:500px;"><b><s:property value="getText('claim.search.help_text')"/></b></small>
        <br>
          ...
          <table class="table"  style="width:650px;;margin-left:15px; border-width: 0px;"><tr><td style="width:80%;border-top: 1px solid #ffffff;"> <div style="height:100px;" class="tab-content">
              <div id="tab_1" class="tab-pane active">
                  ...
                  <s:property value="getText('order.id')"/>:</td>
                      <td style="width:30%;">
                  <input id="orderID" name="orderID" style="margin:1px; " type="text" class="form-control">
                  </td>
                  </tr>
                   <tr>
                  <td style="width:20%;">
                  ...
                  <table><tr><td><input style="margin:1px;width:95%;" type="text" placeholder="From" class="form-control" id="datepicker1" name="datepicker1"></td>
                            <td><input style="margin:1px;width:95%;" type="text" placeholder="To" class="form-control" id="datepicker2" name="datepicker2"></td></tr></table>
                ...
                <tr>
                   ...
                   <s:property value="getText('order.totals')"/>:
                    ...
                    <td style="width:30%;">
                        <table><tr><td><input id="order_total_from" name="order_total_from"  style="margin:1px;width:95%;" type="text" placeholder="From" class="form-control"   onkeypress='return isNumberKey(event);'></td>
                            <td><input id="order_total_to" name="order_total_to"  style="margin:1px;width:95%;" type="text" placeholder="To" class="form-control"  onkeypress='return isNumberKey(event);'></td></tr></table>
              ...
              <div id="tab_2" class="tab-pane">
               <table style="width:100%;">
                ...
                <s:property value="getText('claim.id')"/>:</td>
                      <td style="width:30%;">
                  <input id="claimID" style="margin:1px; " type="text" class="form-control">
                  </td>
                  </tr>                
                    <tr>
                  <td style="width:20%;">
              ...
              <table style="width:100%;">
                  ...
                  <s:property value="getText('cust.id.label')"/>:</td>
                      <td style="width:30%;">
                  <input name="customerInfo" id="customerInfo" style="margin:1px; " type="text" class="form-control">
                  </td>
                  <!--  <td><button type="button" class="btn pull-right" >Search</button></td> -->
                  </tr>
                    <tr>
                  <td style="width:30%;">
                   <s:property value="getText('item.id.label')"/>:</td>
                      <td style="width:30%;">
                  <input id="claimItemId1" style="margin:1px; " type="text" class="form-control">
                  </td>
                  </tr>   </table>      
              </div>
              <!-- /.tab-pane -->
...
<%--                 <label class="radio inline"><input id="99" type="radio" name="Invoice_Search" value="All" checked>
                ...
                <span>Closed </span></label>  --%>
                    ...
                    <button  onclick="searchOrder()"class="btn pull-right" id="claimSearch"
        ...
        <div class="box box-primary">
            ...
            <div class="box-header">
              <h3 class="box-title" style="color: #226e71;"><s:property value="getText('all.claims')"/></h3> &nbsp;<i><h3 class="box-title" style="color: #226e71;" id="Current_Date_Range"></h3></i>
                <div class="box-tools">
...
.table-striped>tbody>tr:nth-of-type(2n+1) {
	background-color: #F2F2F2;
							...
							<thead>
								<tr style="background-color: #ADC2EE;">
									...
									<th id ="claimDate" style="text-align:center;"><s:property value="getText('claim.date')"/></th>
									...
									<th><s:property value="getText('table.head.qty')"/></th>	
 ...
 <s:iterator value="rejectClaim_List"  status="itStatus">
      ...
      <td id="ClaimId">
       <a href="ClaimSearchDetails?claimID=<s:property value="claimId"/>"><s:property value="claimId"/></a>
      </td>
    ...
    $(function() {
					//tab-3	
						$("input#claimItemId1").autocomplete({
							...
							$("#claimItemId1").autocomplete("widget").attr('style',
    ...
    function searchOrder(){
     	...
     	if(isValidDataInTab(activeTab)){
            ...
            document.forms["hidden_order_data"].customerInfo.value=$('#customerInfo').val();  
             ...
             //clearing the input search fields  action="allClaimByCustomerName" 
             $("#claimID").val('');
             $("#datepicker3").val('');
             $("#datepicker4").val('');
             $("#ClaimTotalTo").val('');
    ...
    <form action="allClaimByCustomerName"  name="hidden_order_data" method="post">

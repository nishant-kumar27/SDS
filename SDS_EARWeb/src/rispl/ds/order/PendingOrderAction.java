...
public class PendingOrderAction extends DSAction implements Preparable{

	private static final long serialVersionUID = 1L;

	private static final Logger LOG = LogManager.getLogger(PendingOrderAction.class);
...
/*changed by hanu*/
public String setPendingOrderSession(){
	...
	// process start by jagadish for need to display discount description in order_Details page 

          ...
          <h2 style="color: #226e71;">
             <s:property value="getText('invoice.details')"/>
              <div class="pull-right hidden-print"><h5>
                  ...
                  <a id="dwnldLPO" href="<s:property value="#downloadInvoiceUrl"/>" style="text-decoration:none" class="pull-right"><i class="fa fa-save"></i> <s:property value="getText('save.label')"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </a></h5></div>
<!--            <small class="pull-right">Date: 2/10/2014</small>-->
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
          <table style="width:100%;" class="table">
			...
			<tr><td style="text-align:right;"><s:property value="getText('order.date')"/>:</b></td><td><b><span id="OrderDate"><s:date name="invDetail.orderDate" format="%{getText('format.date')}" /></span></b></td></tr>
          ...
          <td  class="visible-print-inline"><b><s:i18n name="invoiceText" ><s:text name="CRN" /></s:i18n></b></td></tr>  
        </table>
        </div>
        <!-- /.col -->
      </div>
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped" style="margin-bottom: 2px;">
            ...
            <tr style="background-color:#ADC2EE;">
              ...
              <th style="text-align:right;"><s:property value="getText('discount.amt')"/></th>
      ...
      <%--              <s:if test="%{#ordTranDscItms[0].dscPer>0}">
             ...
             <td style="text-align:right;"><s:property value="%{getText('format.currency.args',{#dscAmts})}"/></td>
...
<%--       <s:if test="invDetail.invStatus=='0'"><td style="text-align:right;"><s:property value="lineQnt"/></td></s:if>
                   
       <s:else><td style="text-align:right;"><s:property value="%{0}"/> </td></s:else> --%>
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-lg-5 col-md-6 col-xs-5 pull-right">

          <div class="table-responsive">
            <table class="table">
              <tbody><tr>
                <td style="text-align:right;width:50%"><s:property value="getText('subtotal.label')"/>:</td>
                <td style="text-align:right;"><s:property value="getText('global.currency')"/>&nbsp;&nbsp; <b><span id="Subtotal"><s:property value="%{getText('format.currency.args',{orders[0].ordTranSum.dkartSlsTot})}"/></span></b></td>
                  </tr>
              <tr>
                <td style="text-align:right;"><s:property value="getText('total.discount')"/>:</td>
                <td style="text-align:right;"><span id="Discount"><b><s:property value="%{getText('format.currency.args',{orders[0].ordTranSum.dkartDscTot})}"/></b></span></td>
              </tr>
              <tr>
                <td style="text-align:right;"><s:property value="getText('total.tax')"/>:</td>
                <td style="text-align:right;"><span id="TotalTax"><b><s:property value="%{getText('format.currency.args',{orders[0].ordTranSum.dkartTaxTot})}"/></b></span></td>
              </tr>
              <tr >
                <td style="text-align:right;"><s:property value="getText('table.head.total')"/>:</td>
                <td style="text-align:right;"><s:property value="getText('global.currency')"/>&nbsp;&nbsp; <b> <span id="TotalInvAmt"><s:property value="%{getText('format.currency.args',{invDetail.invAmount})}"/></span></b></td>
              </tr>
                  <tr>
                  <s:set var="totalInvamt" value="invDetail.invAmount"/>
                  <s:set var="totalPenamt" value="invDetail.invPendAmount"/>
                  <td style="text-align:right;width:50%;"><s:property value="getText('received.amt')"/>:</td><td style="text-align:right;">
					<s:property value="getText('global.currency')"/>&nbsp;&nbsp; <span id="ReceivedAmt"><b><s:property value="%{getText('format.currency.args',{#totalInvamt-#totalPenamt})}"/></b></span></td></tr>
                  <tr>
                <td style="text-align:right;"><s:property value="getText('balance.due')"/>:</td>
                <td style="text-align:right;"><s:property value="getText('global.currency')"/>&nbsp;&nbsp; <b> <span id="BalanceDue"><s:property value="%{getText('format.currency.args',{invDetail.invPendAmount})}"/></span></b></td>
              </tr>
...
<%-- 			<button id="paymnt" onclick="myFunction()" type="button" class="btn  pull-right hidden-print" style="color:#ffffff; width:140px;margin-top:5px; background:    #3d85c6;
        ...
        <s:if test="%{enableRecordPaymentButton}">
          	<button id="paymnt" onclick="" type="button" class="btn  pull-right hidden-print disabled" style="color:#ffffff; width:140px;margin-top:5px; background:    #3d85c6;
				background:    -webkit-linear-gradient(#1770c1, #073763 50%, #1770c1);
				background:    linear-gradient(#1770c1, #073763 50%, #1770c1);  
				color:         #fff;
				display:       inline-block;">
          ...
          <!-- <a href="invoiceCancellation" class="hidden-print"><button  type="button" class="btn  pull-left" style="color:#ffffff; width:100px;margin-top:5px; background:    #3d85c6;
			background:    -webkit-linear-gradient(#1770c1, #073763 50%, #1770c1);
			background:    linear-gradient(#1770c1, #073763 50%, #1770c1); 
			color:         #fff;
			display:       inline-block;">

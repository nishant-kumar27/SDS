...
<title>SDS | Open Invoice Search</title>
...
<div class="wrapper">
  ...
  <div style="min-height: 595px;" class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Your Page Content Here -->
        <label style="font-size:25px;color: #226e71;"><s:property value="getText('open.invoice.search')"/></label>
            <small class="pull-right" style="text-align:right;font-size:14px;color:#8e8e8e;width:500px;"><b><s:property value="getText('invoice.search.help_text')"/></b></small>
        <br>
 ...
 <table class="table"  style="width:650px;;margin-left:15px; border-width: 0px;"><tr><td style="width:80%;border-top: 1px solid #ffffff;"> <div style="height:100px;" class="tab-content">
              ...
              <div id="tab_2" class="tab-pane">
               <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td style="width:30%;">
                        <table><tr><td><input id="InvoiceTotalFrom" style="margin:1px;width:95%;" type="text" placeholder="From" class="form-control"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'></td>
                            <td><input id="InvoiceTotalTo" style="margin:1px;width:95%;" type="text" placeholder="To" class="form-control"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'></td></tr></table>
              ...
              <!-- /.tab-pane -->
               ...
               <span><s:property value="getText('overdue_status')"/></span></label></div> 
                ...
                <lab name="Info_Text" style="font-style:italic;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:property value="getText('message_6')"/></lab>
		    ...
		    <s:if test="%{#results==null}">
 			 <!-- this is intial case when the page is called first rejectClaim_List --> 
 			 <!-- no action required -->
 			 </s:if>
 			  <s:elseif test="%{#results==0}">
 			<%--  <label style="color:red;"><span id="noOfInv"><s:property value="results"/></span> <s:property value="getText('message_7')"/></label> --%>
 			 </s:elseif>
 			<s:elseif test="%{#results>0}">
 			 <!-- More than 0 records found -->
 			 <label style="color:green;"><span id="noOfOrd"><s:property value="results"/></span> <s:property value="getText('message_7')"/></label>
 			 </s:elseif>

			    <s:set var="results1" value="%{rejectClaim_List.length}"/>
		    <s:if test="%{#results1==0}">
 			 <label style="color:red;"><span id="noOfOrd"><s:property value="results1"/></span> <s:property value="getText('message_7')"/></label></s:if>
              
            <!-- /.box-body -->
        <div class="box box-primary">
            
            <div class="box-header">
              <h3 class="box-title" style="color: #226e71;"><s:property value="getText('open_invoices')"/></h3> &nbsp;<i><h3 class="box-title" style="color: #226e71;" id="Current_Date_Range"></h3></i>
                <div class="box-tools">
               <div class="dropdown pull-right" style="margin-right:10px;"> 
                      ...
                      <li><a href="javascript:void(0)" class="week" id="week" onclick='rangeFilter("invoiceDate","invoiceList",this.id);'><s:property value="getText('week_to_date')"/></a></li>
                        <li><a href="javascript:void(0)" class="month" id="month" onclick='rangeFilter("invoiceDate","invoiceList",this.id);'><s:property value="getText('month_to_date')"/></a></li>
                        <li><a href="javascript:void(0)"  class="quarter" id="quarter" onclick='rangeFilter("invoiceDate","invoiceList",this.id);'><s:property value="getText('quarter_to_date')"/></a></li>
                        <li><a href="javascript:void(0)"  class="year" id="year" onclick='rangeFilter("invoiceDate","invoiceList",this.id);'><s:property value="getText('year_to_date')"/></a></li>
                        <li><a href="javascript:void(0)" class="none" id="none" onclick='rangeFilter("invoiceDate","invoiceList",this.id);'><s:property value="getText('none')"/></a></li>
                        </ul>
...
.table-striped>tbody>tr:nth-of-type(2n+1) {
	background-color: #F2F2F2;
								...
								<tr style="background-color: #ADC2EE;">
									...
									<th id="invoiceDate"><s:property value="getText('invoice.date')"/></th>
									...
									<th style="text-align:right;"><s:property value="getText('age.label')"/>(<s:property value="getText('days.label')"/>)</th>
 ...
 <s:iterator value="invoices"  status="itStatus">
    ...
    <td>
      ...
      <td id="InvoiceId">
       <a href="OpenInvoiceDetail?invoiceID=<s:property value="arInvNum"/>"><s:property value="arInvNum"/></a>
      </td>
      <td>
             <s:date name="arInvDate" format="%{getText('format.date')}" />
      </td>
       <td style="text-align:right;">
            <s:property value="%{getText('format.currency.args',{invAmount})}"/>
      </td>
      ...
      <td style="text-align:right;"><s:property value="%{((CurrentDate.getTime() - arInvDate.getTime()) / (1000 * 60 * 60 * 24) )}"/></td>
   
       <td>
             <a href="invoice_orders_details_page?orderId=<s:property value="orderNum"/>"><s:property value="orderNum"/>
      </td>
       <td style="text-align:right;">
             <s:property value="%{getText('format.currency.args',{invAmount-invPendAmount})}"/>
      </td>
       <td style="text-align:right;">
             <s:property value="%{getText('format.currency.args',{invPendAmount})}"/>
      </td>
    ...
    function searchInvoice(){
    	...
    	if(isValidDataInTab(activeTab)){
    		...
    		if(activeTab === "tab_1"){
    			...
    			document.hidden_order_data.action ="openInvoiceSearchByOrder";
    		}else
    			if(activeTab === "tab_2"){
    				...
    				if(activeTab === "tab_3"){
    					...
    					document.hidden_order_data.action ="openInvoiceSearchByCustomer";
    				}
...
<script>
 $(function(){
	  var searchRange = "${openInvoiceSearchRange}";

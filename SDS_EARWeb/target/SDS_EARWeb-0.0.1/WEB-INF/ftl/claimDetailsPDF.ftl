	...
	<#list claimTranLineItems as lineItem>
			...
			<td>
				<#if lineItem.accptClaimPrice??>
  					<h6>${lineItem.accptClaimPrice}</h6>
				<#else>
  					<#assign x = 0>
  					<h6>${x}</h6>			
  				</#if>
...
<table align="right" width="30%">
		<tr>
			<td><small>Sub Total</small></td><td>:</td><td style="text-align:right;"><small><@s.property value="getText('global.currency')"/>&nbsp;&nbsp;  ${dkartNetTot + dkartDiscTot}</small></td>
		</tr>
		<tr>

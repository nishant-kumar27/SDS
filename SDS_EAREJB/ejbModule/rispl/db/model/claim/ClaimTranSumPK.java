...
/**
 * The primary key class for the CLAIM_TRAN_SUM database table.
 * 
 */
@Embeddable
public class ClaimTranSumPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ClaimTranSumPK)) {
			return false;
		}
		ClaimTranSumPK castOther = (ClaimTranSumPK) other;

...
/**
 * The primary key class for the CLAIM_TRAN_LINE_ITEM database table.
 * 
 */
@Embeddable
public class ClaimTranLineItemPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ClaimTranLineItemPK)) {
			return false;
		}
		ClaimTranLineItemPK castOther = (ClaimTranLineItemPK) other;
		return this.rtStrId.equals(castOther.rtStrId) && this.ordWs.equals(castOther.ordWs)
				&& (this.trnSeq == castOther.trnSeq) && (this.ordLnItmSeq == castOther.ordLnItmSeq)

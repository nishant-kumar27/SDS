 ...
 */
@Embeddable
public class CustomerSitePK implements Serializable {
    ...
    public CustomerSitePK() {
    }

    public CustomerSitePK(BigInteger custSiteId, String custId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CustomerSitePK)) {
            return false;
        }
        CustomerSitePK other = (CustomerSitePK) object;
    ...
    public String toString() {
        return "entity.CustomerSitePK[ custSiteId=" + custSiteId + ", custId=" + custId + " ]";
    }

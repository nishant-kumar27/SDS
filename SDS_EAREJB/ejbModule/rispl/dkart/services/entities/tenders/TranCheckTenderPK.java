...
/**
 * The primary key class for the DK_TRAN_CHK_TND database table.
 * 
 */
@Embeddable
public class TranCheckTenderPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TranCheckTenderPK)) {
			return false;
		}
		TranCheckTenderPK castOther = (TranCheckTenderPK)other;
		return 

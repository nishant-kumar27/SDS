...
/**
 * The primary key class for the DK_TRAN_LTM_VCHR_TND database table.
 * 
 */
@Embeddable
public class TranVoucherTenderPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TranVoucherTenderPK)) {
			return false;
		}
		TranVoucherTenderPK castOther = (TranVoucherTenderPK)other;
		return 

...
/**
 * The persistent class for the ORD_TRAN_SUM database table.
 * 
 */
@Entity
@Table(name="ORD_TRAN_SUM")
@NamedQuery(name="OrderTranSum.findAll", query="SELECT o FROM OrderTranSum o")
public class OrderTranSum implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private OrderTranSumPK id;
	...
	private BigDecimal dkartTndTot=BigDecimal.ZERO;

	@Column(name="DKART_DS_APLD")
	private BigDecimal dkartDsApld;

	@Column(name="DKART_DSC_TOT")
	private BigDecimal dkartDscTot=BigDecimal.ZERO;

	@Column(name="DKART_NET_TOT")
	private BigDecimal dkartNetTot=BigDecimal.ZERO;

	@Column(name="DKART_SLS_TOT")
	private BigDecimal dkartSlsTot=BigDecimal.ZERO;

	@Column(name="DKART_TAX_INC_TOT")
	private BigDecimal dkartTaxIncTot=BigDecimal.ZERO;

	@Column(name="DKART_TAX_TOT")
	private BigDecimal dkartTaxTot=BigDecimal.ZERO;
	...
	@Temporal(TemporalType.DATE)
	@Column(name="ORD_DLVR_DATE")
	private Date ordDlvrDate;
	
	@Column(name="ORD_DLVR_TIME_PERIOD")
	private int ordDlvrTimePeriod;
	...
	private BigDecimal dkartExpenses=BigDecimal.ZERO;
	
	@Column(name="ORIG_ID_ORD")
	private String origOrderId;
	
    // to hold totalExcludingServicePrice
	@Transient
	private BigDecimal totalExcludingServicePrice;
	...
	public OrderTranSumPK getId() {
		return this.id;
	}

	public void setId(OrderTranSumPK id) {
		this.id = id;
	}
	...
	public Date getOrdDlvrDate() {
		return ordDlvrDate;
	}

	public void setOrdDlvrDate(Date ordDlvrDate) {
		this.ordDlvrDate = ordDlvrDate;
	}

	

	public int getOrdDlvrTimePeriod() {
		return ordDlvrTimePeriod;
	}

	public void setOrdDlvrTimePeriod(int ordDlvrTimePeriod) {
		this.ordDlvrTimePeriod = ordDlvrTimePeriod;
	}

	public BigDecimal getTotalExcludingServicePrice() {
		return totalExcludingServicePrice;
	}

	public void setTotalExcludingServicePrice(BigDecimal totalExcludingServicePrice) {
		this.totalExcludingServicePrice = totalExcludingServicePrice;
	}

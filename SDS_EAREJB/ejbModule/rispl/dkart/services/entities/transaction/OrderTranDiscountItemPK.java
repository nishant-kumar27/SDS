...
/**
 * The primary key class for the ORD_TRAN_DSC_ITM database table.
 * 
 */
@Embeddable
public class OrderTranDiscountItemPK implements Serializable {
	...
	public OrderTranDiscountItemPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof OrderTranDiscountItemPK)) {
			return false;
		}
		OrderTranDiscountItemPK castOther = (OrderTranDiscountItemPK)other;
		return 
